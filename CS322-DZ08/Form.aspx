<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Form.aspx.cs" Inherits="CS322_DZ08.Form" %>
...
<body>
	<header class="fb-header">
		<div class="inner-header">
			<img class="fb-header-logo" src="fb.png">
			<form class="login-grid">
				<label class="email-label" for="email or phone">Email or Phone</label>
				<span class="blue-text"><input type="checkbox">Keep me logged in</input></span>
				...
				<span class="Forgotten-item"><a href="#">Forgot your password?</a></span>
		...
		<div class="fb-container">
			...
			<section class="fb-form">
					...
					<form class="sign-up" id="form1" runat="server">
						<asp:TextBox ID="txtFirstName" runat="server" class="frm-textbox textbox-width" type="text" name="text" placeholder="First Name"></asp:TextBox>
						<asp:TextBox ID="txtLastName" runat="server" class="frm-textbox textbox-width" type="text" name="text" placeholder="Last Name"></asp:TextBox>
						<asp:TextBox ID="txtEmail" runat="server" class="frm-textbox" type="text" name="text" placeholder="Your Email"></asp:TextBox><br/>
						<asp:TextBox ID="txtEmailReenter" runat="server" class="frm-textbox" type="text" name="text" placeholder="Re-enter Email"></asp:TextBox><br/>
						<asp:TextBox ID="txtPassword" runat="server" class="frm-textbox" type="password" name="password" placeholder="New Password"></asp:TextBox><br/>
						<div class="form-div">
							...
							<a class="why-link" href="#">Why do I need to provide my birthday?</a><br>
							<div class="frm-radio">
							...
							<asp:Button ID="btnSubmit" runat="server" CssClass="signupButton" class="signupButton" Text="Sign Up" OnClick="btnSubmit_Click" />
